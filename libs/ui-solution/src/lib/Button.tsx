...
const classNames = {
  primary: 'inline-block whitespace-nowrap text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5',
  secondary: [
    'inline-block whitespace-nowrap py-2.5 px-5 text-sm font-medium text-slate-900 bg-white rounded-lg border border-gray-200',
...
export const Button = function ButtonComponent<C extends ElementType = 'button'>({
  ...
  return (
    <Component {...restProps} className={cn(classNames[variant], className)}>
      {children}
