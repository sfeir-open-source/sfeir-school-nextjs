...
const ExpenseDetailsRow = ({ label, value }: ExpenseDetailsRowProps) => (
  <div>
  ...
  <>
    ...
    <div className="flex gap-4">
      <div className="w-1/2">
        ...
        <ExpenseDetailsRow label="Without taxes" value={`${expense.price.priceExcludingTax} ${expense.price.currency}`} />
