...
type PersonCardProps = HTMLAttributes<HTMLDivElement> & {
  person: Person;
  actions?: React.ReactNode;
  compact?: boolean;
};

export const PersonCard = ({ person, actions, className, compact = false }: PersonCardProps) => {
  return (
    <div className={cn('bg-white p-4 rounded-lg dark:bg-slate-900', className)}>
